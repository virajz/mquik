...
{
    /** @var array{brand_id: ?int, model_id: ?int, name: string, fuel_type: ?string, year: ?int, transmission: ?string} */
    ...
    public function createQuickVehicle(): void
    {
        ...
        $validated = $this->validate([
            ...
            'quickVehicle.fuel_type' => ['nullable', 'in:petrol,diesel,cng,electric,hybrid'],
            'quickVehicle.year' => ['nullable', 'integer', 'min:1980', 'max:'.((int) date('Y') + 1)],
            'quickVehicle.transmission' => ['nullable', 'in:manual,automatic,amt,cvt,dct'],
        ], [], [
            'quickVehicle.brand_id' => 'brand',
            'quickVehicle.model_id' => 'model',
            'quickVehicle.name' => 'variant name',
            'quickVehicle.fuel_type' => 'fuel type',
            'quickVehicle.year' => 'year',
            'quickVehicle.transmission' => 'transmission',
        ])['quickVehicle'];
