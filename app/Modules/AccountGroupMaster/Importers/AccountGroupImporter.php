...
class AccountGroupImporter implements Importable
{
    ...
    {
        AccountGroupMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var AccountGroupMaster $existing */
