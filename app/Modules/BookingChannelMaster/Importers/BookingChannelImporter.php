...
namespace App\Modules\BookingChannelMaster\Importers;
...
class BookingChannelImporter implements Importable
{
    ...
    {
        BookingChannelMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var BookingChannelMaster $existing */
