...
class BusinessTypeImporter implements Importable
{
    ...
    {
        BusinessTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var BusinessTypeMaster $existing */
