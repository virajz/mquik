...
namespace App\Modules\BusinessTypeMaster\Livewire;
...
class Form extends Component
{
    ...
    protected function rules(): array
    {
        return [
            'name' => ['required', 'string', 'max:255',
                Rule::unique('business_types', 'name')->ignore($this->editingId),
            ],
            'code' => ['nullable', 'string', 'max:20',
                Rule::unique('business_types', 'code')->ignore($this->editingId),
            ],
            'is_active' => ['boolean'],
    ...
    public function load(?int $id): void
    {
        ...
        $record = BusinessTypeMaster::findOrFail($id);
    ...
    {
        $this->authorize($this->editingId ? 'business_type_master.update' : 'business_type_master.create');
        ...
        $this->resetForm();
        Flux::modal('business-type-master-form')->close();
    }
    ...
    {
        return view('business-type-master::form');
    }
}
