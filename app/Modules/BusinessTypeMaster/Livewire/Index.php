...
class Index extends Component
{
    ...
    {
        $this->dispatch('business-type-master:edit', id: null);
        Flux::modal('business-type-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('business-type-master:edit', id: $id);
        Flux::modal('business-type-master-form')->show();
    }

    #[On('business-type-master:saved')]
    ...
    {
        $this->authorize('business_type_master.delete');
    ...
    public function render()
    {
        ...
        return view('business-type-master::index', ['rows' => $rows]);
    }
}
