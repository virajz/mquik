...
class CancelReasonImporter implements Importable
{
    ...
    {
        CancelReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var CancelReasonMaster $existing */
