...
class Index extends Component
{
    ...
    {
        $this->dispatch('cancel-reason-master:edit', id: null);
        Flux::modal('cancel-reason-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('cancel-reason-master:edit', id: $id);
        Flux::modal('cancel-reason-master-form')->show();
    }

    #[On('cancel-reason-master:saved')]
    ...
    {
        $this->authorize('cancel_reason_master.delete');
    ...
    public function render()
    {
        ...
        return view('cancel-reason-master::index', ['rows' => $rows]);
    }
}
