...
class ChallanReasonImporter implements Importable
{
    ...
    {
        ChallanReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ChallanReasonMaster $existing */
