...
class ChargeTypeImporter implements Importable
{
    ...
    {
        ChargeTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ChargeTypeMaster $existing */
