...
namespace App\Modules\ChecklistGroupMaster\Importers;
...
class ChecklistGroupImporter implements Importable
{
    ...
    {
        ChecklistGroupMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ChecklistGroupMaster $existing */
