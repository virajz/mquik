...
class Index extends Component
{
    ...
    {
        $this->dispatch('checklist-group-master:edit', id: null);
        Flux::modal('checklist-group-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('checklist-group-master:edit', id: $id);
        Flux::modal('checklist-group-master-form')->show();
    }

    #[On('checklist-group-master:saved')]
    ...
    public function delete(int $id): void
    {
        ...
        try {
            ...
            Flux::toast(
                text: 'Cannot delete this group — it is still in use by one or more templates.',
                variant: 'danger',
            );
        }
    }
    ...
    public function render()
    {
        ...
        $rows = ChecklistGroupMaster::query()
        ...
        return view('checklist-group-master::index', ['rows' => $rows]);
    }
}
