...
class ClaimTypeImporter implements Importable
{
    ...
    {
        ClaimTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ClaimTypeMaster $existing */
