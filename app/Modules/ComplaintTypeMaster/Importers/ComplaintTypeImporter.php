...
class ComplaintTypeImporter implements Importable
{
    ...
    {
        ComplaintTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ComplaintTypeMaster $existing */
