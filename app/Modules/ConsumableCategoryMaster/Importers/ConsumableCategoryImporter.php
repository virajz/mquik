...
namespace App\Modules\ConsumableCategoryMaster\Importers;
...
class ConsumableCategoryImporter implements Importable
{
    ...
    {
        ConsumableCategoryMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ConsumableCategoryMaster $existing */
