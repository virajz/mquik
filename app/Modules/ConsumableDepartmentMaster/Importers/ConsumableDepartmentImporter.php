...
namespace App\Modules\ConsumableDepartmentMaster\Importers;
...
class ConsumableDepartmentImporter implements Importable
{
    ...
    {
        ConsumableDepartmentMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ConsumableDepartmentMaster $existing */
