...
namespace App\Modules\CourierCompanyMaster\Importers;
...
class CourierCompanyImporter implements Importable
{
    ...
    {
        CourierCompanyMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var CourierCompanyMaster $existing */
