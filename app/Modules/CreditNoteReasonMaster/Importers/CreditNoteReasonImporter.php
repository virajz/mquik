...
namespace App\Modules\CreditNoteReasonMaster\Importers;
...
class CreditNoteReasonImporter implements Importable
{
    ...
    {
        CreditNoteReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var CreditNoteReasonMaster $existing */
