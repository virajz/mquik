...
namespace App\Modules\CustomerApprovalTypeMaster\Importers;
...
class CustomerApprovalTypeImporter implements Importable
{
    ...
    {
        CustomerApprovalTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var CustomerApprovalTypeMaster $existing */
