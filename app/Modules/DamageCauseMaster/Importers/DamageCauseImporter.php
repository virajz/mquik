...
class DamageCauseImporter implements Importable
{
    ...
    {
        DamageCauseMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var DamageCauseMaster $existing */
