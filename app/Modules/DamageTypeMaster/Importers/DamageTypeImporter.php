...
class DamageTypeImporter implements Importable
{
    ...
    {
        DamageTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var DamageTypeMaster $existing */
