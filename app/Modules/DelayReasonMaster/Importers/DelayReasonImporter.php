...
class DelayReasonImporter implements Importable
{
    ...
    {
        DelayReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var DelayReasonMaster $existing */
