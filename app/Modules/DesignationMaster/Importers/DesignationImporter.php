...
class DesignationImporter implements Importable
{
    ...
    {
        DesignationMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var DesignationMaster $existing */
