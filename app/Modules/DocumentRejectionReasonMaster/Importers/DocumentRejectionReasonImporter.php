...
namespace App\Modules\DocumentRejectionReasonMaster\Importers;
...
class DocumentRejectionReasonImporter implements Importable
{
    ...
    {
        DocumentRejectionReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var DocumentRejectionReasonMaster $existing */
