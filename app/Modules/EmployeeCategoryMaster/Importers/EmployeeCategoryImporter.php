...
namespace App\Modules\EmployeeCategoryMaster\Importers;
...
class EmployeeCategoryImporter implements Importable
{
    ...
    {
        EmployeeCategoryMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var EmployeeCategoryMaster $existing */
