...
class EmployeeGradeImporter implements Importable
{
    ...
    {
        EmployeeGradeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var EmployeeGradeMaster $existing */
