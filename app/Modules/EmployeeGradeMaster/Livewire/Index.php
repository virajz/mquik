...
class Index extends Component
{
    ...
    {
        $this->dispatch('employee-grade-master:edit', id: null);
        Flux::modal('employee-grade-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('employee-grade-master:edit', id: $id);
        Flux::modal('employee-grade-master-form')->show();
    }

    #[On('employee-grade-master:saved')]
    ...
    {
        $this->authorize('employee_grade_master.delete');

        try {
            $record = EmployeeGradeMaster::findOrFail($id);
            $record->delete();
            Flux::toast(text: 'Employee Grade #'.$id.' deleted.', variant: 'success');
    ...
    public function render()
    {
        ...
        $rows = EmployeeGradeMaster::query()
        ...
        return view('employee-grade-master::index', ['rows' => $rows]);
    }
}
