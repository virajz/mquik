...
class EnquirySourceImporter implements Importable
{
    ...
    {
        EnquirySourceMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var EnquirySourceMaster $existing */
