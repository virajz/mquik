...
namespace App\Modules\EstimateRevisionReasonMaster\Importers;
...
class EstimateRevisionReasonImporter implements Importable
{
    ...
    {
        EstimateRevisionReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var EstimateRevisionReasonMaster $existing */
