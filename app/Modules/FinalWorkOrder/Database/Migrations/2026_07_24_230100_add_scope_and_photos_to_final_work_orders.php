...
return new class extends Migration
{
    ...
    {
        Schema::create('final_work_order_scopes', function (Blueprint $table) {
            $table->id();
            $table->foreignId('final_work_order_id')->constrained()->cascadeOnDelete();
            ...
            $table->index(['final_work_order_id', 'sequence_no'], 'fwo_scopes_order_sequence_index');
        });

        Schema::create('final_work_order_photos', function (Blueprint $table) {
            $table->id();
            $table->foreignId('final_work_order_id')->constrained()->cascadeOnDelete();
            ...
            $table->index(['final_work_order_id', 'sequence_no'], 'fwo_photos_order_sequence_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('final_work_order_photos');
        Schema::dropIfExists('final_work_order_scopes');
    }
};
