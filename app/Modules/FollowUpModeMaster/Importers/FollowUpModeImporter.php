...
class FollowUpModeImporter implements Importable
{
    ...
    {
        FollowUpModeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var FollowUpModeMaster $existing */
