...
class FuelTypeImporter implements Importable
{
    ...
    {
        FuelTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var FuelTypeMaster $existing */
