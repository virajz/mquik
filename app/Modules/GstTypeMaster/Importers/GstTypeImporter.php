...
class GstTypeImporter implements Importable
{
    ...
    {
        GstTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var GstTypeMaster $existing */
