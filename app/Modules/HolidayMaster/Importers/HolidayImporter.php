...
class HolidayImporter implements Importable
{
    ...
    {
        HolidayMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var HolidayMaster $existing */
