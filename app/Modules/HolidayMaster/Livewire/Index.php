...
class Index extends Component
{
    ...
    {
        $this->dispatch('holiday-master:edit', id: null);
        Flux::modal('holiday-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('holiday-master:edit', id: $id);
        Flux::modal('holiday-master-form')->show();
    }

    #[On('holiday-master:saved')]
    ...
    {
        $this->authorize('holiday_master.delete');

        try {
            $record = HolidayMaster::findOrFail($id);
            $record->delete();
            Flux::toast(text: 'Holiday #'.$id.' deleted.', variant: 'success');
    ...
    public function render()
    {
        ...
        return view('holiday-master::index', ['rows' => $rows]);
    }
}
