...
namespace App\Modules\IncentivePolicyMaster\Importers;
...
class IncentivePolicyImporter implements Importable
{
    ...
    {
        IncentivePolicyMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var IncentivePolicyMaster $existing */
