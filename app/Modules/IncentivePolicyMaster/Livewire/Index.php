...
class Index extends Component
{
    ...
    {
        $this->dispatch('incentive-policy-master:edit', id: null);
        Flux::modal('incentive-policy-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('incentive-policy-master:edit', id: $id);
        Flux::modal('incentive-policy-master-form')->show();
    }

    #[On('incentive-policy-master:saved')]
    ...
    {
        $this->authorize('incentive_policy_master.delete');

        try {
            $record = IncentivePolicyMaster::findOrFail($id);
            $record->delete();
            Flux::toast(text: 'Incentive Policy #'.$id.' deleted.', variant: 'success');
    ...
    public function render()
    {
        ...
        $rows = IncentivePolicyMaster::query()
        ...
        return view('incentive-policy-master::index', ['rows' => $rows]);
    }
}
