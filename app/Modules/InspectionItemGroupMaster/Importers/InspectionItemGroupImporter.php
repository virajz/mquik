...
namespace App\Modules\InspectionItemGroupMaster\Importers;
...
class InspectionItemGroupImporter implements Importable
{
    ...
    {
        InspectionItemGroupMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var InspectionItemGroupMaster $existing */
