...
class Index extends Component
{
    ...
    {
        $this->dispatch('inspection-item-group-master:edit', id: null);
        Flux::modal('inspection-item-group-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('inspection-item-group-master:edit', id: $id);
        Flux::modal('inspection-item-group-master-form')->show();
    }

    #[On('inspection-item-group-master:saved')]
    ...
    public function render()
    {
        ...
        $rows = InspectionItemGroupMaster::query()
        ...
        return view('inspection-item-group-master::index', ['rows' => $rows]);
    }
}
