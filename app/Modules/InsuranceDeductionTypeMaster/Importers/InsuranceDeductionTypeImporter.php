...
namespace App\Modules\InsuranceDeductionTypeMaster\Importers;
...
class InsuranceDeductionTypeImporter implements Importable
{
    public function label(): string
    {
        return 'Insurance Deduction Types';
    }
    ...
    {
        InsuranceDeductionTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var InsuranceDeductionTypeMaster $existing */
