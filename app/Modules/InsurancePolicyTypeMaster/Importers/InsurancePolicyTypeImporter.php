...
namespace App\Modules\InsurancePolicyTypeMaster\Importers;
...
class InsurancePolicyTypeImporter implements Importable
{
    ...
    {
        InsurancePolicyTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var InsurancePolicyTypeMaster $existing */
