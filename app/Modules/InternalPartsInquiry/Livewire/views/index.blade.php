<div>
    ...
    <div class="mb-6 flex items-start justify-between gap-4">
        <div>
            <flux:heading size="xl" level="1">InternalPartsInquiry</flux:heading>
            <flux:text class="mt-1">Manage your InternalPartsInquiry records.</flux:text>
        </div>

        <div class="flex items-center gap-2">
            <flux:button variant="primary" icon="plus" wire:click="openCreate">
                New InternalPartsInquiry
            </flux:button>
    ...
    <livewire:import-export.export-button :module="'InternalPartsInquiry'" wire:key="export-internal-parts-inquiry" />
    <livewire:import-export.import-wizard :module="'InternalPartsInquiry'" wire:key="import-internal-parts-inquiry" />
        ...
        <flux:table.rows>
            @forelse ($rows as $row)
                <flux:table.row :key="$row->id">
                    ...
                    <flux:table.cell class="text-zinc-500 max-w-md truncate">{{ $row->description }}</flux:table.cell>
                    ...
                    <flux:table.cell>
                        <div class="flex items-center justify-end gap-1">
                            ...
                            <flux:modal.trigger :name="'internal-parts-inquiry-delete-' . $row->id">
                                <flux:button size="sm" variant="ghost" icon="trash" />
                            </flux:modal.trigger>

                            <flux:modal :name="'internal-parts-inquiry-delete-' . $row->id">
                                <div class="space-y-4">
                                    ...
                                    <div class="flex gap-2 justify-end">
                                        ...
                                        <flux:button variant="danger"
                                            ...
                                            x-on:click="$flux.modal('internal-parts-inquiry-delete-{{ $row->id }}').close()">
                                            Delete
                                        </flux:button>
                                    </div>
                                </div>
            ...
            @empty
                <flux:table.row>
                    <flux:table.cell colspan="5" class="text-center text-zinc-500 py-12">
                        ...
                        <flux:text class="mt-1">Get started by creating your first InternalPartsInquiry.</flux:text>
                    </flux:table.cell>
                </flux:table.row>
            @endforelse
        </flux:table.rows>
    ...
    <livewire:internal-parts-inquiry.form />
</div>
