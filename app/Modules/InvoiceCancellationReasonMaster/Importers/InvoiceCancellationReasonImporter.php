...
namespace App\Modules\InvoiceCancellationReasonMaster\Importers;
...
class InvoiceCancellationReasonImporter implements Importable
{
    ...
    {
        InvoiceCancellationReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var InvoiceCancellationReasonMaster $existing */
