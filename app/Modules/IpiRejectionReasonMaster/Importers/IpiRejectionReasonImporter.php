...
namespace App\Modules\IpiRejectionReasonMaster\Importers;
...
class IpiRejectionReasonImporter implements Importable
{
    ...
    {
        IpiRejectionReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var IpiRejectionReasonMaster $existing */
