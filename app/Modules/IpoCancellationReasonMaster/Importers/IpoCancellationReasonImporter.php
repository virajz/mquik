...
namespace App\Modules\IpoCancellationReasonMaster\Importers;
...
class IpoCancellationReasonImporter implements Importable
{
    ...
    {
        IpoCancellationReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var IpoCancellationReasonMaster $existing */
