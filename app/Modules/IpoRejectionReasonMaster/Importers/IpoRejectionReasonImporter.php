...
namespace App\Modules\IpoRejectionReasonMaster\Importers;
...
class IpoRejectionReasonImporter implements Importable
{
    public function label(): string
    {
        return 'IPO Rejection Reasons';
    }
    ...
    {
        IpoRejectionReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var IpoRejectionReasonMaster $existing */
