...
namespace App\Modules\JobCardCancelReasonMaster\Importers;
...
class JobCardCancelReasonImporter implements Importable
{
    ...
    {
        JobCardCancelReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var JobCardCancelReasonMaster $existing */
