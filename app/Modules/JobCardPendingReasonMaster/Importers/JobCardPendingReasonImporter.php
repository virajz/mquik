...
namespace App\Modules\JobCardPendingReasonMaster\Importers;
...
class JobCardPendingReasonImporter implements Importable
{
    ...
    {
        JobCardPendingReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var JobCardPendingReasonMaster $existing */
