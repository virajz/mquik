        ...
        <form wire:submit="save" novalidate class="space-y-5">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <flux:date-picker locale="en-IN" wire:model="from_date" label="From" with-today selectable-header fixed-weeks type="input" required />
                    <flux:date-picker locale="en-IN" wire:model="to_date" label="To" with-today selectable-header fixed-weeks type="input" required />
                </div>
