...
class LeaveTypeImporter implements Importable
{
    ...
    {
        LeaveTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var LeaveTypeMaster $existing */
