...
class LoanTypeImporter implements Importable
{
    ...
    {
        LoanTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var LoanTypeMaster $existing */
