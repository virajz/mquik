...
class LossReasonImporter implements Importable
{
    ...
    {
        LossReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var LossReasonMaster $existing */
