...
class LossTypeImporter implements Importable
{
    ...
    {
        LossTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var LossTypeMaster $existing */
