...
class Index extends Component
{
    ...
    {
        $this->dispatch('loss-type-master:edit', id: null);
        Flux::modal('loss-type-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('loss-type-master:edit', id: $id);
        Flux::modal('loss-type-master-form')->show();
    }

    #[On('loss-type-master:saved')]
    ...
    {
        $this->authorize('loss_type_master.delete');

        try {
            $record = LossTypeMaster::findOrFail($id);
            $record->delete();
            Flux::toast(text: 'Loss Type #'.$id.' deleted.', variant: 'success');
    ...
    public function render()
    {
        ...
        return view('loss-type-master::index', ['rows' => $rows]);
    }
}
