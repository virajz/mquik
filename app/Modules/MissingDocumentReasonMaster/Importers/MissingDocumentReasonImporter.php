...
namespace App\Modules\MissingDocumentReasonMaster\Importers;
...
class MissingDocumentReasonImporter implements Importable
{
    ...
    {
        MissingDocumentReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var MissingDocumentReasonMaster $existing */
