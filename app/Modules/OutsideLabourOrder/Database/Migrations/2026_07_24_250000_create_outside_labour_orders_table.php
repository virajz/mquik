...
return new class extends Migration
{
    ...
    {
        Schema::create('outside_labour_orders', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('outside_labour_order_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('outside_labour_order_id')->constrained('outside_labour_orders')->cascadeOnDelete();
            ...
            $table->index(['outside_labour_order_id', 'sequence_no']);
            $table->index(['outside_labour_order_id', 'result']);
        });

        Schema::create('outside_labour_order_pauses', function (Blueprint $table) {
            $table->id();
            $table->foreignId('outside_labour_order_id')->constrained('outside_labour_orders')->cascadeOnDelete();
            $table->foreignId('hold_reason_id')->nullable()->constrained('work_order_hold_reasons')->nullOnDelete();
            ...
            $table->index(['outside_labour_order_id', 'paused_at']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('outside_labour_order_pauses');
        Schema::dropIfExists('outside_labour_order_items');
        Schema::dropIfExists('outside_labour_orders');
    }
};
