...
namespace App\Modules\OutsideLabourRejectionReasonMaster\Importers;
...
class OutsideLabourRejectionReasonImporter implements Importable
{
    ...
    {
        OutsideLabourRejectionReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var OutsideLabourRejectionReasonMaster $existing */
