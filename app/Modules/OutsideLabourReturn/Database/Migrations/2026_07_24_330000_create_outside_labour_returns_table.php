...
return new class extends Migration
{
    ...
    {
        Schema::create('outside_labour_returns', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('outside_labour_return_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('outside_labour_return_id')->constrained()->cascadeOnDelete();
            ...
            $table->index(['outside_labour_return_id', 'sequence_no'], 'olr_items_return_sequence_index');
        });

        Schema::create('outside_labour_return_attachments', function (Blueprint $table) {
            $table->id();
            $table->foreignId('outside_labour_return_id')->constrained()->cascadeOnDelete();
            ...
            $table->index(['outside_labour_return_id', 'sequence_no'], 'olr_attachments_return_sequence_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('outside_labour_return_attachments');
        Schema::dropIfExists('outside_labour_return_items');
        Schema::dropIfExists('outside_labour_returns');
    }
};
