@php($OLR = \App\Modules\OutsideLabourReturn\Models\OutsideLabourReturn::class)
@php($ITEM = \App\Modules\OutsideLabourReturn\Models\OutsideLabourReturnItem::class)
@php($ATT = \App\Modules\OutsideLabourReturn\Models\OutsideLabourReturnAttachment::class)
<div>
    <form wire:submit="save" class="max-w-4xl">
        <div class="mb-8">
            <flux:link :href="route('outside-labour-return.index')" variant="ghost" class="text-xs">
                <flux:icon.chevron-left class="inline size-3 -mt-0.5" /> Outside Labour Return / Warranty
            </flux:link>
            <flux:heading size="xl" level="1" class="mt-1">{{ $editingId ? ($return_no ?: 'Edit Return') : 'New Outside Labour Return / Warranty Claim' }}</flux:heading>
        ...
        <div class="flex items-center justify-end gap-2 py-6">
            <flux:button :href="route('outside-labour-return.index')" variant="ghost" wire:navigate>Cancel</flux:button>
