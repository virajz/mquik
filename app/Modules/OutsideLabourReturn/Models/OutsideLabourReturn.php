...
use App\Modules\OutsideLabourReturn\Database\Factories\OutsideLabourReturnFactory;
...
class OutsideLabourReturn extends Model
{
    use Auditable;
    use HasFactory;
    use Searchable;
    ...
    protected $table = 'outside_labour_returns';
    ...
    protected static function newFactory(): OutsideLabourReturnFactory
    {
        return OutsideLabourReturnFactory::new();
    }
    ...
    protected static function booted(): void
    {
        static::created(function (self $row) {
            if ($row->return_no === null) {
                $row->forceFill(['return_no' => 'OLRR-'.str_pad((string) $row->id, 5, '0', STR_PAD_LEFT)])->saveQuietly();
            }
        });
    }
    ...
    {
        return $this->hasMany(OutsideLabourReturnItem::class, 'outside_labour_return_id')->orderBy('sequence_no');
    }

    public function attachments(): HasMany
    {
        return $this->hasMany(OutsideLabourReturnAttachment::class, 'outside_labour_return_id')->orderBy('sequence_no');
    }
}
