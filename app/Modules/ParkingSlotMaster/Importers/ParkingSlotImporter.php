...
class ParkingSlotImporter implements Importable
{
    ...
    {
        ParkingSlotMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ParkingSlotMaster $existing */
