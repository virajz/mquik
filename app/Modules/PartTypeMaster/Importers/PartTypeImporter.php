...
class PartTypeImporter implements Importable
{
    ...
    {
        PartTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var PartTypeMaster $existing */
