...
namespace App\Modules\PaymentCancellationReasonMaster\Importers;
...
class PaymentCancellationReasonImporter implements Importable
{
    ...
    {
        PaymentCancellationReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var PaymentCancellationReasonMaster $existing */
