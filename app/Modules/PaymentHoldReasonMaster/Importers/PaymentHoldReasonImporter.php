...
namespace App\Modules\PaymentHoldReasonMaster\Importers;
...
class PaymentHoldReasonImporter implements Importable
{
    ...
    {
        PaymentHoldReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var PaymentHoldReasonMaster $existing */
