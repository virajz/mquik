...
class PaymentModeImporter implements Importable
{
    ...
    {
        PaymentModeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var PaymentModeMaster $existing */
