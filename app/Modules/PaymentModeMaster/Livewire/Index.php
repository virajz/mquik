...
class Index extends Component
{
    ...
    {
        $this->dispatch('payment-mode-master:edit', id: null);
        Flux::modal('payment-mode-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('payment-mode-master:edit', id: $id);
        Flux::modal('payment-mode-master-form')->show();
    }

    #[On('payment-mode-master:saved')]
    ...
    public function render()
    {
        ...
        return view('payment-mode-master::index', ['rows' => $rows]);
    }
}
