...
class PendingReasonImporter implements Importable
{
    ...
    {
        PendingReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var PendingReasonMaster $existing */
