...
class Index extends Component
{
    ...
    {
        $this->dispatch('pending-reason-master:edit', id: null);
        Flux::modal('pending-reason-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('pending-reason-master:edit', id: $id);
        Flux::modal('pending-reason-master-form')->show();
    }

    #[On('pending-reason-master:saved')]
    ...
    {
        $this->authorize('pending_reason_master.delete');
    ...
    public function render()
    {
        ...
        $rows = PendingReasonMaster::query()
        ...
        return view('pending-reason-master::index', ['rows' => $rows]);
    }
}
