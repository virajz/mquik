...
namespace App\Modules\PerformanceSlabMaster\Importers;
...
class PerformanceSlabImporter implements Importable
{
    ...
    {
        PerformanceSlabMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var PerformanceSlabMaster $existing */
