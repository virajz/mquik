...
class Index extends Component
{
    ...
    {
        $this->dispatch('performance-slab-master:edit', id: null);
        Flux::modal('performance-slab-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('performance-slab-master:edit', id: $id);
        Flux::modal('performance-slab-master-form')->show();
    }

    #[On('performance-slab-master:saved')]
    ...
    {
        $this->authorize('performance_slab_master.delete');

        try {
            $record = PerformanceSlabMaster::findOrFail($id);
            $record->delete();
            Flux::toast(text: 'Performance Slab #'.$id.' deleted.', variant: 'success');
    ...
    public function render()
    {
        ...
        $rows = PerformanceSlabMaster::query()
        ...
        return view('performance-slab-master::index', ['rows' => $rows]);
    }
}
