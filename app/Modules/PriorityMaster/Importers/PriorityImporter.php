...
namespace App\Modules\PriorityMaster\Importers;

use App\Modules\ImportExport\Contracts\Importable;
use App\Modules\PriorityMaster\Models\PriorityMaster;
use Illuminate\Support\Facades\Validator;

class PriorityImporter implements Importable
{
    ...
    public function columns(): array
    {
        return [
            ...
            'sort_order' => [
                ...
                'type' => 'integer',
                'default' => 0,
                'help' => 'Severity order — lower shows first.',
            ],
            'is_active' => [
                'label' => 'Active',
                'required' => false,
    ...
    {
        PriorityMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var PriorityMaster $existing */
