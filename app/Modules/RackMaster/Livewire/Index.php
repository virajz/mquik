...
class Index extends Component
{
    ...
    {
        $this->dispatch('rack-master:edit', id: null);
        Flux::modal('rack-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('rack-master:edit', id: $id);
        Flux::modal('rack-master-form')->show();
    }

    #[On('rack-master:saved')]
    ...
    {
        $this->authorize('rack_master.delete');

        try {
            $record = RackMaster::findOrFail($id);
            $record->delete();
            Flux::toast(text: 'Rack #'.$id.' deleted.', variant: 'success');
    ...
    public function render()
    {
        ...
        return view('rack-master::index', ['rows' => $rows]);
    }
}
