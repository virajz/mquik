...
namespace App\Modules\ReceiptCancellationReasonMaster\Importers;
...
class ReceiptCancellationReasonImporter implements Importable
{
    ...
    {
        ReceiptCancellationReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ReceiptCancellationReasonMaster $existing */
