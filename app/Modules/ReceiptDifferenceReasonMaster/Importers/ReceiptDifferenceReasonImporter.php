...
namespace App\Modules\ReceiptDifferenceReasonMaster\Importers;
...
class ReceiptDifferenceReasonImporter implements Importable
{
    ...
    {
        ReceiptDifferenceReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ReceiptDifferenceReasonMaster $existing */
