...
#[Layout('layouts.app')]
#[Title('Receipt Difference Reasons')]
class Index extends Component
{
    ...
    {
        $this->dispatch('receipt-difference-reason-master:edit', id: null);
        Flux::modal('receipt-difference-reason-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('receipt-difference-reason-master:edit', id: $id);
        Flux::modal('receipt-difference-reason-master-form')->show();
    }

    #[On('receipt-difference-reason-master:saved')]
    ...
    {
        $this->authorize('receipt_difference_reason_master.delete');

        try {
            $record = ReceiptDifferenceReasonMaster::findOrFail($id);
            $record->delete();
            Flux::toast(text: 'Receipt Difference Reason #'.$id.' deleted.', variant: 'success');
    ...
    public function render()
    {
        ...
        $rows = ReceiptDifferenceReasonMaster::query()
        ...
        return view('receipt-difference-reason-master::index', ['rows' => $rows]);
    }
}
