...
class RefundTypeImporter implements Importable
{
    ...
    {
        RefundTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var RefundTypeMaster $existing */
