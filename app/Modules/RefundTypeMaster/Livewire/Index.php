...
class Index extends Component
{
    ...
    {
        $this->dispatch('refund-type-master:edit', id: null);
        Flux::modal('refund-type-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('refund-type-master:edit', id: $id);
        Flux::modal('refund-type-master-form')->show();
    }

    #[On('refund-type-master:saved')]
    ...
    {
        $this->authorize('refund_type_master.delete');

        try {
            $record = RefundTypeMaster::findOrFail($id);
            $record->delete();
            Flux::toast(text: 'Refund Type #'.$id.' deleted.', variant: 'success');
    ...
    public function render()
    {
        ...
        return view('refund-type-master::index', ['rows' => $rows]);
    }
}
