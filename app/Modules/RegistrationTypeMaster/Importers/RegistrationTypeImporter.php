...
namespace App\Modules\RegistrationTypeMaster\Importers;
...
class RegistrationTypeImporter implements Importable
{
    ...
    {
        RegistrationTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var RegistrationTypeMaster $existing */
