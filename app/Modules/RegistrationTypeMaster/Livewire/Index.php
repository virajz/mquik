...
class Index extends Component
{
    ...
    {
        $this->dispatch('registration-type-master:edit', id: null);
        Flux::modal('registration-type-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('registration-type-master:edit', id: $id);
        Flux::modal('registration-type-master-form')->show();
    }

    #[On('registration-type-master:saved')]
    ...
    public function render()
    {
        ...
        $rows = RegistrationTypeMaster::query()
        ...
        return view('registration-type-master::index', ['rows' => $rows]);
    }
}
