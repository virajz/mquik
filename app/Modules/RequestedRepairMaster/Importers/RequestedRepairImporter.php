...
namespace App\Modules\RequestedRepairMaster\Importers;
...
class RequestedRepairImporter implements Importable
{
    ...
    {
        RequestedRepairMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var RequestedRepairMaster $existing */
