...
class ReturnTypeImporter implements Importable
{
    ...
    {
        ReturnTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ReturnTypeMaster $existing */
