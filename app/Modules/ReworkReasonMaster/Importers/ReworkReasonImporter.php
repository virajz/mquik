...
class ReworkReasonImporter implements Importable
{
    ...
    {
        ReworkReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ReworkReasonMaster $existing */
