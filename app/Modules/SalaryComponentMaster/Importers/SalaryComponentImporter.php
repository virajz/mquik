...
namespace App\Modules\SalaryComponentMaster\Importers;
...
class SalaryComponentImporter implements Importable
{
    ...
    {
        SalaryComponentMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var SalaryComponentMaster $existing */
