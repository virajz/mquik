...
class Index extends Component
{
    ...
    {
        $this->dispatch('salary-component-master:edit', id: null);
        Flux::modal('salary-component-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('salary-component-master:edit', id: $id);
        Flux::modal('salary-component-master-form')->show();
    }

    #[On('salary-component-master:saved')]
    ...
    {
        $this->authorize('salary_component_master.delete');

        try {
            $record = SalaryComponentMaster::findOrFail($id);
            $record->delete();
            Flux::toast(text: 'Salary Component #'.$id.' deleted.', variant: 'success');
    ...
    public function render()
    {
        ...
        $rows = SalaryComponentMaster::query()
        ...
        return view('salary-component-master::index', ['rows' => $rows]);
    }
}
