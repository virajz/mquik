...
namespace App\Modules\SalesReturnReasonMaster\Importers;
...
class SalesReturnReasonImporter implements Importable
{
    ...
    {
        SalesReturnReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var SalesReturnReasonMaster $existing */
