...
class Index extends Component
{
    ...
    {
        $this->dispatch('sales-return-reason-master:edit', id: null);
        Flux::modal('sales-return-reason-master-form')->show();
    }

    public function openEdit(int $id): void
    {
        $this->dispatch('sales-return-reason-master:edit', id: $id);
        Flux::modal('sales-return-reason-master-form')->show();
    }

    #[On('sales-return-reason-master:saved')]
    ...
    {
        $this->authorize('sales_return_reason_master.delete');

        try {
            $record = SalesReturnReasonMaster::findOrFail($id);
            $record->delete();
            Flux::toast(text: 'Sales Return Reason #'.$id.' deleted.', variant: 'success');
    ...
    public function render()
    {
        ...
        $rows = SalesReturnReasonMaster::query()
        ...
        return view('sales-return-reason-master::index', ['rows' => $rows]);
    }
}
