...
namespace App\Modules\ServicePackageTypeMaster\Importers;
...
class ServicePackageTypeImporter implements Importable
{
    ...
    {
        ServicePackageTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ServicePackageTypeMaster $existing */
