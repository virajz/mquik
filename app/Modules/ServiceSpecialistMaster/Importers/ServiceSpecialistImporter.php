...
namespace App\Modules\ServiceSpecialistMaster\Importers;
...
class ServiceSpecialistImporter implements Importable
{
    ...
    {
        ServiceSpecialistMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var ServiceSpecialistMaster $existing */
