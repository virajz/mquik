...
namespace App\Modules\SpareBrandMaster\Importers;

use App\Modules\ImportExport\Contracts\Importable;
use App\Modules\SpareBrandMaster\Models\SpareBrandMaster;
use Illuminate\Support\Facades\Validator;

class SpareBrandImporter implements Importable
{
    ...
    {
        SpareBrandMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var SpareBrandMaster $existing */
