...
namespace App\Modules\StandardObservationMaster\Importers;
...
class StandardObservationImporter implements Importable
{
    ...
    {
        StandardObservationMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var StandardObservationMaster $existing */
