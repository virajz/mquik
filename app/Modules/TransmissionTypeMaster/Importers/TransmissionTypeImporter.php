...
namespace App\Modules\TransmissionTypeMaster\Importers;
...
class TransmissionTypeImporter implements Importable
{
    ...
    {
        TransmissionTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var TransmissionTypeMaster $existing */
