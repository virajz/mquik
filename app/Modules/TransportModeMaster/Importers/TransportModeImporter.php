...
class TransportModeImporter implements Importable
{
    ...
    {
        TransportModeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var TransportModeMaster $existing */
