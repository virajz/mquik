...
namespace App\Modules\UnitOfMeasureMaster\Importers;

use App\Modules\ImportExport\Contracts\Importable;
use App\Modules\UnitOfMeasureMaster\Models\UnitOfMeasureMaster;
use Illuminate\Support\Facades\Validator;

class UnitOfMeasureImporter implements Importable
{
    ...
    {
        UnitOfMeasureMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var UnitOfMeasureMaster $existing */
