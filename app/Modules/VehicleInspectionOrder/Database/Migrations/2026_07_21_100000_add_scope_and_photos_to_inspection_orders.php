...
return new class extends Migration
{
    ...
    {
        Schema::create('vehicle_inspection_order_scopes', function (Blueprint $table) {
            $table->id();
            $table->foreignId('vehicle_inspection_order_id')->constrained()->cascadeOnDelete();
            ...
            $table->index(['vehicle_inspection_order_id', 'sequence_no'], 'vio_scopes_order_sequence_index');
        });

        Schema::create('vehicle_inspection_order_photos', function (Blueprint $table) {
            $table->id();
            $table->foreignId('vehicle_inspection_order_id')->constrained()->cascadeOnDelete();
            ...
            $table->index(['vehicle_inspection_order_id', 'sequence_no'], 'vio_photos_order_sequence_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('vehicle_inspection_order_photos');
        Schema::dropIfExists('vehicle_inspection_order_scopes');
    }
};
