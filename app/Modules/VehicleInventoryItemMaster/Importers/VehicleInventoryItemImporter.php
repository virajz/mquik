...
namespace App\Modules\VehicleInventoryItemMaster\Importers;
...
class VehicleInventoryItemImporter implements Importable
{
    ...
    {
        VehicleInventoryItemMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var VehicleInventoryItemMaster $existing */
