...
namespace App\Modules\VehicleSegmentMaster\Importers;
...
class VehicleSegmentImporter implements Importable
{
    ...
    {
        VehicleSegmentMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var VehicleSegmentMaster $existing */
