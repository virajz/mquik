...
class VendorTypeImporter implements Importable
{
    ...
    {
        VendorTypeMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var VendorTypeMaster $existing */
