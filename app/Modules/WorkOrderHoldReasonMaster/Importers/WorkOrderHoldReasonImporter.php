...
namespace App\Modules\WorkOrderHoldReasonMaster\Importers;
...
class WorkOrderHoldReasonImporter implements Importable
{
    ...
    {
        WorkOrderHoldReasonMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var WorkOrderHoldReasonMaster $existing */
