...
namespace App\Modules\WorkshopDepartmentMaster\Importers;

use App\Modules\ImportExport\Contracts\Importable;
use App\Modules\WorkshopDepartmentMaster\Models\WorkshopDepartmentMaster;
use Illuminate\Support\Facades\Validator;

class WorkshopDepartmentImporter implements Importable
{
    ...
    {
        WorkshopDepartmentMaster::create($this->normalize($data));
    }

    public function updateRecord(object $existing, array $data): void
    {
        /** @var WorkshopDepartmentMaster $existing */
