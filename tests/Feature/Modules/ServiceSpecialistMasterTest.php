...
use App\Modules\ServiceSpecialistMaster\Livewire\Form;
...
it('renders the index page', function () {
    ServiceSpecialistMaster::factory()->count(3)->create();

    $this->get(route('service-specialist-master.index'))
        ->assertOk()
        ->assertSeeLivewire(Index::class);
});

it('searches by name or code', function () {
    ServiceSpecialistMaster::factory()->create(['name' => 'ENGINEEE NOISE', 'code' => 'ENG']);
    ServiceSpecialistMaster::factory()->create(['name' => 'BRAKEEE PROBLEM', 'code' => 'BRK']);
...
it('filters by active status', function () {
    ServiceSpecialistMaster::factory()->create(['name' => 'ENGINE ENABLED']);
    ServiceSpecialistMaster::factory()->inactive()->create(['name' => 'BRAKE DISABLED']);
...
it('sorts by name alphabetically by default', function () {
    ServiceSpecialistMaster::factory()->create(['name' => 'ZEBRA TYPE']);
    ServiceSpecialistMaster::factory()->create(['name' => 'ALPHA TYPE']);
    ServiceSpecialistMaster::factory()->create(['name' => 'MIDDLE TYPE']);
...
it('creates a type with code', function () {
    Livewire::test(Form::class)
        ...
        ->call('save')
        ->assertHasNoErrors()
        ->assertDispatched('service-specialist-master:saved');

    $record = ServiceSpecialistMaster::firstOrFail();
...
it('updates an existing type', function () {
    $record = ServiceSpecialistMaster::factory()->create(['name' => 'OLD NAME']);

    Livewire::test(Form::class)
        ->dispatch('service-specialist-master:edit', id: $record->id)
...
it('deletes a type from the index', function () {
    $record = ServiceSpecialistMaster::factory()->create();

    Livewire::test(Index::class)->call('delete', $record->id);

    expect(ServiceSpecialistMaster::find($record->id))->toBeNull();
});

it('validates name is required and unique', function () {
    ServiceSpecialistMaster::factory()->create(['name' => 'EXISTING']);
...
it('allows updating a type without triggering self-uniqueness conflict', function () {
    $record = ServiceSpecialistMaster::factory()->create(['name' => 'ENGINE NOISE']);
...
it('requires authentication', function () {
    ...
    $this->get(route('service-specialist-master.index'))->assertRedirect(route('login'));
});
